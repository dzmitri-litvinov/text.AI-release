...
#define RUS_LETTERS "ÀàÂÑñÅåÍÊêÌÎîĞğÒÕõ"
#define RUS_LETTERS_LOWER_CASE "àáâãäå¸æçèéêëìíîïğñòóôõöøùúûüışÿ"
#define RUS_LETTERS_UPPER_CASE "ÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖØÙÚÛÜİŞß"

const string EXCLUSIONS[] = { "÷òä", "ëèáî", "èëè", "÷òî", "÷òîáû", "êàê", "íèáóäü", "òîëüêî", "çàòî", "òàêæå", "êîãäà", "÷åì"};
